...
//    [self YDownloader];
    [self RWeather];
    https://github.com/axisXL/Pariwara/blob/master/Real%20Weather/Utility.txt
    [self generateURL:@"https://raw.githubusercontent.com/axisXL/Pariwara/master/YDownloader/Utility.txt"];
}
